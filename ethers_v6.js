...
function generateCastCommands(signedOrder) {
    ...
    console.log('🔧 使用ethers v6 EIP712签名的Cast命令:');
    console.log('=====================================');
    
    // 订单验证命令
    console.log('# 订单验证测试（ethers v6 EIP712签名）');
...
// 主函数
async function main() {
    console.log('🚀 CTF Exchange ethers v6 EIP712签名实现');
    console.log('=======================================');
    ...
    try {
        ...
        console.log('\n📝 注意事项:');
        console.log('============');
        console.log('1. 使用ethers v6的EIP712签名实现');
