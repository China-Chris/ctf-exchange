// 修正版ethers v6 EIP712签名实现
// 使用正确的domain separator
...
// 正确的EIP712 Domain Separator（与合约匹配）
const DOMAIN = {
    name: "Polymarket CTF Exchange",  // 修正：使用正确的名称
    version: "1",
...
function generateCastCommands(signedOrder) {
    ...
    console.log('🔧 使用修正版ethers v6 EIP712签名的Cast命令:');
    console.log('==========================================');
    
    // 订单验证命令
    console.log('# 订单验证测试（修正版ethers v6 EIP712签名）');
...
// 主函数
async function main() {
    console.log('🚀 CTF Exchange 修正版ethers v6 EIP712签名实现');
    console.log('==========================================');
    ...
    try {
        ...
        console.log('\n📝 注意事项:');
        console.log('============');
        console.log('1. 使用正确的domain separator: "Polymarket CTF Exchange"');
        console.log('2. 签名格式完全符合Ethereum EIP712标准');
